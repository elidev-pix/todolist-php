 ...
 *
 * Protégée par l'authentification : seules les tâches de l'utilisateur connecté sont affichées
 */
require 'auth.php';
require_once 'csrf.php';

$sql = 'SELECT * FROM todoliste WHERE user_id = :user_id ORDER BY todo_id DESC';
$resultat = $pdo->prepare($sql);
$resultat->bindParam(':user_id', $current_user_id);
$resultat->execute();
...
<head>
    ...
    <style>
        ...
        .topbar-link:hover { color: #f87171; }
    ...
    <div class="max-w-2xl mx-auto px-4 py-12">
        ...
        <div class="mb-10 flex items-start justify-between">
            ...
            <div class="text-right">
                <p class="text-slate-400 text-xs mb-1">Connecté en tant que <span class="text-white font-medium"><?= htmlspecialchars($_SESSION['username']) ?></span></p>
                <a href="logout.php" class="topbar-link">Se déconnecter</a>
            </div>
        </div>
